...
function findElementGreaterThan(arr, num) {
  return Array.isArray(arr) ? arr.find(elem => elem > num) ? arr.find(elem => elem > num) : "Числа яке задовільняе умову не знайдено" : undefined;
...
function findIndexByProperty(arr, name) {;
  return Array.isArray(arr) ? arr.findIndex((elem) => elem.name === name) : -1;
...
function findLastEvenNumber(arr) {
  return Array.isArray(arr) ? arr.findLast(elem => elem % 2 === 0) ? arr.findLast(elem => elem % 2 === 0) : "Парних чисел не знайдено" : "Вхідний параметр має бути масивом"
...
function getSubArrayAndConvertToString(arr, startIdx) {
  return Array.isArray(arr) ? arr.slice(startIdx).join(" ") : "Вхідний параметр має бути масивом";
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getArrayKeys(arr) {
  return Array.isArray(arr) ? Array.from(arr.keys()) : 'Вхідний параметр має бути масивом'
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getPositiveArrayValues(arr) {
  return Array.isArray(arr) ? Array.from(arr.values()).filter(elem => elem > 0) : 'Вхідний параметр має бути масивом';
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function flattenSquareAndFilter(arr, threshold) {
  return Array.isArray(arr) ? arr.flat().map(elem => elem ** 2).filter(elem => elem > threshold) : "Вхідний параметр має бути масивом"
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getLastElementsSumAndPrint(arr, n) {
  function sl(arr, n) {
    ...
    return a.reduceRight((a,b) => a + b )
  }
  return Array.isArray(arr) ? sl(arr, n) : "Вхідний параметр має бути масивом";
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function wordLengths(arr) {
  return Array.isArray(arr) ? arr.map(elem => elem.length) : "Вхідний параметр має бути масивом";
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
...
function insertElementAt(arr, index, element) {
  function ar(arr,index,elem) {
    arr.splice(index, 1 , elem);
    return arr
  }
  return Array.isArray(arr) ? ar(arr,index,element) : 'Вхідний параметр має бути масивом';
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function expandArrayByN(arr, n) {
  return Array.isArray(arr) && Number.isInteger(n) ? arr.flatMap(elem => Array(n).fill(elem)) : 'Перший вхідний параметр має бути масивом, другий - числом';
...
function findLongestWord(arr) {
  return Array.isArray(arr) ? arr.reduce((acum,elem) => (acum.length < elem.length ? acum = elem : acum)) : "";
...
function findDuplicateElements(arr) {
  if (Array.isArray(arr)) {
    return arr.filter((elem , index, arr) => index !== arr.indexOf(elem))
  } else {
    return ""
  }
...
function capitalizeWords(arr) {
  ...
  return Array.isArray(arr) ? ar(arr) : [];
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо пустий масив
...
function calculateTotalPrice(arr) {
  function ar(arr) {
    let totalPrice = arr.reduce(function (accumulator,currentValue) {
      accumulator.price = accumulator.price + currentValue.price;
      return accumulator
    })
    return totalPrice.price
  };
  return Array.isArray(arr) ? ar(arr) : 0;
...
function findLastNegativeNumberIndex(arr) {
  return Array.isArray(arr) ? arr.findLastIndex(elem => elem < 0 ) : -1;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо -1
